...
<html lang="en">
<head>
	<title>Update Political Party</title>
	<meta charset="UTF-8">
...
$psuid = $_GET['psuid'];   
$set = "SELECT * FROM pparties where ID='$psuid'";
...
{
    echo "✓ Political Party update success!";
}
	...
	<div class="limiter  " >
      ...
      <div class="regpic">
        <center>
				...
				<form method="post" enctype="multipart/form-data" class="login100-form validate-form" style="margin: auto;
  width: 50%;
  padding: 10px;" action="nebe_handler/ppupdatehandler.php?psuid=<?php echo $psuid ?>" >
					<span class="login100-form-title">    
						Update Political party Account
					</span>
                    <p>User Name </p>
					<div class="wrap-input100 validate-input" >
...
error_reporting(0);
  ...
  ?> </h5>
                    ...
                    <p>Party Name </p>
					<div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="pname" placeholder="Party Name"value="<?php echo $final['party_name']?>">
						<span class="focus-input100"></span>
					</div>
                    <p>Abbreviation </p>
					<div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="abbr" placeholder="Abbreviation" value="<?php echo $final['abbr']?>">
						<span class="focus-input100"></span>
					</div>
						
						<div class="wrap-input100">
						<p>Symbol </p>
                                <input type="file" id="picture" name="file" value="<?php echo $final['symbol']?>" style="border: 1px solid #ccc; 
