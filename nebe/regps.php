...
<button class="dropbtn" class="fas fa-bars">MANAGE USERS 1
    </button>   
    <div class="dropdown-content">
...
if( $_GET['action'] == 'success' ) 
{
  ...
  width: 50%;
  padding: 10px;" action="nebe_handler/pshandler.php" >
...
<option value="Select">Select SubCity....</option>
...
<option value="Akaky kality">Akaky kality</option>
					...
					<div class="wrap-input100 validate-input" >
						<input class="input100" type="number" name="wereda" placeholder="wereda">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input" >
						<input class="input100" type="number" name="ketena" placeholder="Ketena">
						<span class="focus-input100"></span>
					</div>
