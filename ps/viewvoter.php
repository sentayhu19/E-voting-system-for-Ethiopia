...
<!--===============================================================================================-->
	...
	<link rel="stylesheet" type="text/css" href="ps_assets/main.css">
<!--===============================================================================================-->
...
<body>
  ...
  padding: 10px;" >
            ...
            <img src="../assets/images/search.png" width="30px" height="30px" align="left" style=" text-align: left;">
    ...
    width:100px;">
                ...
                <table border="1px">
                    <thead>
                <tr>
                <th colspan="16" style="text-align: center;">Registered Voters</th>
                </tr> 
                    </thead>   
                    <thead>       
                    <tr>
...
$flag=1;
                ...
                if($result->num_rows>0 )
                {
                    ...
                    {
                        if( $row["subcity"]==$_SESSION ['Subcity']  && $row["wereda"]==$_SESSION ['wereda'] && $row["ketena"]==$_SESSION ['ketena'])
{                          if ((!empty($search)) )
    {
        $flag=1;
        if($search==$row["user_name"])
        {
                        ...
                        "</td><td>".$row["wereda"].
                        "</td><td>".$row["ketena"]."</td><td>".$row["station_id"]."</td><td>".$row["status"]."</td><td>".$row["duration_of_residence"]."</td><td>".$row["house_number"]."</td><td>".$row["remark"].
                        ...
                        if($search=="" &&  $row["subcity"]==$_SESSION ['Subcity']  && $row["wereda"]==$_SESSION ['wereda'] && $row["ketena"]==$_SESSION ['ketena'])
                        {   
